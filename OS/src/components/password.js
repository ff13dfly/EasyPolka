    ...
    <Row>
      ...
      <Col lg = { 12 } xs = { 12 } className="pt-2 pb-4">
        <p>
          ...
          &nbsp;&nbsp;Please record these words, it is the only way to get your account back.
        </p>
      </Col>
      <Col lg = { 12 } xs = { 12 } className="pt-4">
				<Form.Control size = "lg" type = "password" placeholder = "Password..." onChange = {(ev)=>{self.changePassword(ev)}}/>
			</Col>
      <Col lg = { 12 } xs = { 12 } className="pt-2">
				<Form.Control size = "lg" type = "password" 
          placeholder = "Confirm..." 
          onChange = {(ev)=>{self.changeConfirm(ev)}}
          className={border}
        />
			</Col>
      ...
      <Col lg = { 5 } xs = { 5 } className = "pt-2 text-end" >
        <Button size = "md" variant="primary" onClick={()=>{self.addAccount()}}>Set password</Button>
      </Col>
    </Row>
  );
}
