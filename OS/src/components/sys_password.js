    ...
    <Row>
      ...
      lg={size.row[0]} xl={size.row[0]} xxl={size.row[0]}>
        <Form.Control size = "md" type = "password" 
          placeholder = "Password..." onChange = {(ev)=>{
            self.changePassword(ev)
        }}/>
      </Col>
      <Col xs={size.set[0]} sm={size.row[0]} md={size.row[0]} lg={size.row[0]} xl={size.row[0]} xxl={size.row[0]}>

      </Col>
      <Col className="text-end" xs={size.set[1]} sm={size.row[1]} md={size.row[1]} 
