...
function TypeData(props) {
  ...
  return (
    <Row>
      <Col xs={size.basic[0]} sm={size.basic[0]} md={size.basic[0]}
        lg={size.basic[0]} xl={size.basic[0]} xxl={size.basic[0]} >
        <small>Name</small>
        <h5>{name}</h5>
      </Col>
      <Col xs={size.basic[1]} sm={size.basic[1]} md={size.basic[1]}
        lg={size.basic[1]} xl={size.basic[1]} xxl={size.basic[1]} >
        <small>Block</small>
      ...
      <Col xs={size.owner[0]} sm={size.owner[0]} md={size.owner[0]}
        lg={size.owner[0]} xl={size.owner[0]} xxl={size.owner[0]} >
