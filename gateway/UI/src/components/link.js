...
function Link(props) {
  ...
  return (
    <Row>
      <Col md={4} lg={4} xl={4} xxl={4} className="pt-3">
        <h4 className="pt-2">Gateway UI</h4>
      </Col>
      <Col md={2} lg={2} xl={2} xxl={2} className="pt-3 text-end">
        <Button variant="default" onClick={() => {
          self.onClean()
        }}>Clean</Button>
      </Col>
      <Col md={5} lg={5} xl={5} xxl={5} className="pt-3">
      ...
      <Col md={1} lg={1} xl={1} xxl={1} className="pt-3 text-end">
        <Button onClick={() => {
          self.onClick()
        }}>Save</Button>
      </Col>
